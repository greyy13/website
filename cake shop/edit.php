...
if (isset($_POST["submit"])) {
  ...
  $sql = "UPDATE `payment` SET `name`='$name',`flavor`='$flavor',`modeofpayment`='$modeofpayment'WHERE id = $id";
    ...
    <div class="container d-flex justify-content-center">
      <form action="" method="post" style="width:50vw; min-width:300px;">
        ...
        <div class="col">
          ...
          <input type="text" class="form-control" name="modeofpayment" value="<?php echo $row['modeofpayment'] ?>">
        </div>
